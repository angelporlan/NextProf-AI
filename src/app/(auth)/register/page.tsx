  ...
  return (
    <div className="relative min-h-screen bg-[#FAFAFA] dark:bg-[#0B0F19] flex items-center justify-center p-4 transition-colors duration-300">
      ...
      <div className="w-full max-w-md bg-white dark:bg-[#1F2937] p-8 rounded-xl shadow-[0_4px_20px_-4px_rgba(30,27,75,0.05)] dark:shadow-[0_4px_20px_-4px_rgba(0,0,0,0.3)] border border-[#1E1B4B]/5 dark:border-[#F3F4F6]/5 relative z-10 transition-all duration-300">
        ...
        {error && (
          <div className="bg-rose-50 dark:bg-rose-950/20 border border-rose-200 dark:border-rose-900/40 text-rose-700 dark:text-rose-300 text-xs p-3.5 rounded-lg mb-6 flex items-start gap-2.5 font-sans">
        ...
        {success && (
          <div className="bg-emerald-50 dark:bg-emerald-950/20 border border-emerald-200 dark:border-emerald-900/40 text-emerald-700 dark:text-emerald-300 text-xs p-3.5 rounded-lg mb-6 flex items-start gap-2.5 animate-pulse-subtle font-sans">
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          <div>
            ...
            <div className="relative">
              <User className="absolute left-3.5 top-3.5 w-4 h-4 text-[#1E1B4B]/40 dark:text-[#F3F4F6]/40" strokeWidth={1.75} />
              <input
                type="text"
                required
                value={name}
